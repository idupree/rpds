...
#[cfg(feature = "serde")]
impl<A> Serialize for Vector<A> where A: Serialize {
...
#[cfg(feature = "serde")]
impl<'de, A> Deserialize<'de> for Vector<A> where A: Deserialize<'de> {
...
#[cfg(feature = "serde")]
struct VectorVisitor<A> {
    phantom: PhantomData<A>
}

#[cfg(feature = "serde")]
impl<'de, A> Visitor<'de> for VectorVisitor<A>
